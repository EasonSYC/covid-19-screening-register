...
let lookModel =     "<tr bgcolor=\"COLOR\">" + 
                    ...
                    "</tr>";
let updateModel =   "document.getElementById(\"loginNUM\").onclick = function() {loginInfo[NUM] = (1 - parseInt(loginInfo[NUM])).toString(); alert(\"fuck updatelook\"); updateLook(); check(UA, \"loginInfo\");};" +
