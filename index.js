...
let lookModel =     "<tr bgcolor=\"COLOR\">" + 
                    ...
                    "</tr>";
let updateModel =   "document.getElementById(\"loginNUM\").onclick = function() {alert(\"fuck parseInt\"); loginInfo[NUM] = (1 - parseInt(loginInfo[NUM])).toString(); updateLook(); check(UA, \"loginInfo\");};" +
